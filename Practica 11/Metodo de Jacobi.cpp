...
for(j=0;j<5;j++){
    if(j==0){ 
        ...
        printf("x_1 La iteracion %d es igual a %f, Con error de %f %%\n",j+1,x_iteracion_1,Ea1);
        printf("x_2 La teracion %d es igual a %f, Con error de %f %%\n",j+1,x_iteracion_2,Ea2);
        printf("x_3 La iteracion %d es igual a %f, Con error de %f %%\n",j+1,x_iteracion_3,Ea3);
        }
    }
}